...
const Pago = () => {
  ...
  const getTotal = () => {
    ...
    if (context.mesaSelected) {
      total =
        total +
        parseFloat(context.mesaSelected.precioUnitario * context.mesasQuantity);
    }
    //Mesas
    if (context.sillaSelected) {
      total =
        total +
        parseFloat(
          context.sillaSelected.precioUnitario * context.sillasQuantity
        );
    }
    //Sonido
    ...
    if (paymentSelected == "oxxo") {
      ...
      doc.text(
        ...
        !context.salonSelected
          ? "Salon: " + " " + "$" + "0"
          : "Salon: " + " " + "$" + context.salonSelected.precio
      );
      doc.text(
        120,
        310,
        !context.mesaSelected
          ...
          : "Mesas: " +
              " " +
              "$" +
              context.mesaSelected.precioUnitario * context.mesasQuantity
      );
      doc.text(
        120,
        330,
      ...
      doc.text(
        ...
        !context.sonidoSelected
          ? "Sonido: " + "$" + "0"
          : "Sonido: " + "$" + context.sonidoSelected.precioHora
      );
      doc.text(120, 365, "--------------------------------------");
      ...
      doc.addImage(
        "https://www.actualidadecommerce.com/wp-content/uploads/2020/10/paypal.png",
        200,
        90,
        200,
        100
            ...
            <div className="direction">
              <div className="direction-info">
                {!context.salonSelected ? (
                  ...
                  <p>{context.salonSelected.direccionSalon}</p>
                )}
              </div>
              <div className="editar">
                <a href="#Edit">Editar</a>
            ...
            <div className="list">
              ...
              <div className="concepto">
                ...
                {!context.mesaSelected ? (
                  ...
                  <p>
                    {"$" +
                      context.mesaSelected.precioUnitario *
                        context.mesasQuantity}
                  </p>
                )}
              </div>
              <div className="concepto">
                ...
                {!context.sillaSelected ? (
                  ...
                  <p>
                    {"$" +
                      context.sillaSelected.precioUnitario *
                        context.sillasQuantity}
                  </p>
                )}
              </div>
              <div className="concepto">
